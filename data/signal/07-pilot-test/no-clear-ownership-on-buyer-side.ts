...
export const data: SignalDetail = {
  id: "7-7",
  title: "No clear ownership on buyer side",
  track: "PILOT / TEST . 08 OF 09",
  priority: "P1 - Priority",
  statusLabel: "Negative Signal",
  meaning: {
    description: "This signal indicates a specific moment of engagement in the PILOT / TEST stage. Reading this correctly helps you understand the buyer's current mental state and how to steer the conversation toward a productive outcome.",
    subSignals: [
      {
