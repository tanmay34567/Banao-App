...
export const data: SignalDetail = {
  id: "5-8",
  title: "Comes back with new objections misaligned",
  track: "INTERNAL DISCUSSION . 09 OF 09",
  priority: "P1 - Priority",
  statusLabel: "Negative Signal",
  meaning: {
    description: "This signal indicates a specific moment of engagement in the INTERNAL DISCUSSION stage. Reading this correctly helps you understand the buyer's current mental state and how to steer the conversation toward a productive outcome.",
    subSignals: [
      {
