...
export const data: SignalDetail = {
  id: "6-0",
  title: "Introduces new stakeholders proactively",
  track: "STAKEHOLDER EXPANSION . 01 OF 09",
  priority: "P1 - Priority",
  statusLabel: "Strong Signal",
  meaning: {
    description: "This signal indicates a specific moment of engagement in the STAKEHOLDER EXPANSION stage. Reading this correctly helps you understand the buyer's current mental state and how to steer the conversation toward a productive outcome.",
    subSignals: [
      {
