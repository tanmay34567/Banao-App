...
export const data: SignalDetail = {
  id: "4-3",
  title: "Compares approaches thoughtfully",
  track: "VALIDATION . 04 OF 09",
  priority: "P2 - Priority",
  statusLabel: "Strong Signal",
  meaning: {
    description: "This signal indicates a specific moment of engagement in the VALIDATION stage. Reading this correctly helps you understand the buyer's current mental state and how to steer the conversation toward a productive outcome.",
    subSignals: [
      {
