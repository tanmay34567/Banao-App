...
export const data: SignalDetail = {
  id: "10-2",
  title: "Internal champion pushes closure",
  track: "CLOSE . 03 OF 09",
  priority: "P1 - Priority",
  statusLabel: "Strong Signal",
  meaning: {
    description: "This signal indicates a specific moment of engagement in the CLOSE stage. Reading this correctly helps you understand the buyer's current mental state and how to steer the conversation toward a productive outcome.",
    subSignals: [
      {
