...
export const data: SignalDetail = {
  id: "3-6",
  title: "Deflects deeper questions",
  track: "DISCOVERY . 06 OF 09",
  priority: "P1 - Priority",
  statusLabel: "Caution Signal",
  meaning: {
    description: "This signal indicates a specific moment of engagement in the DISCOVERY stage. Reading this correctly helps you understand the buyer's current mental state and how to steer the conversation toward a productive outcome.",
    subSignals: [
      {
